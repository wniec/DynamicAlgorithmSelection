...
class Agent(Optimizer):
    ...
    def _print_verbose_info(self, fitness, y):
        ...
        is_generation_log = self.verbose and (not self._n_generations % self.verbose)
        is_terminated = self.verbose and self.termination_signal > 0

        if is_generation_log or is_terminated:
    ...
    def _check_early_stopping(self, best_y):
        """Checks if improvement is below threshold and updates counters."""
